...
import persistencia.SQLHelperSistemaOperativo;

/**
 *
 * @author zamuel
 */
public class SistemaOperativo extends javax.swing.JPanel {

    /**
     * Creates new form Sistema Operativo
     */
    Mensaje mesaje;
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("¿No encuentras tu caso de Sistema Operativo?, ¡Publícalo!");
    ...
    public void MostrarSoluciones() {
        try {
            PreparedStatement ps = con.prepareStatement("SELECT * FROM TBLCASOS_SO");
    ...
    public void InsertarPublicacion(String solicitud) {
        ...
        try {
            ...
            ps.setString(2, "Sistema Operativo");
            ps.execute();
