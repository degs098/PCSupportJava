 ...
 * @author samsung
 */
public class InicioInvitado extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioInvitado.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioInvitado().setVisible(true);
            }
        });
    }
