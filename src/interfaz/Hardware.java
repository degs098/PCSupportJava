...
public class Hardware extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PublicarLayout.setVerticalGroup(
            PublicarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelPublicar, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
        );
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getRow() == jListCasos.getSelectedIndex() + 1) {
                    Id.setText( "ID Caso: " + rs.getString(1));
    ...
    public void InsertarPublicacion(String solicitud) {
        ...
        try {
            ...
            mesaje = new Mensaje((JFrame) getRootPane().getParent(), true, "¡Tu solicitud ha sido enviada \n exitosamente al personal de soporte!", 2);
            mesaje.setVisible(true);
            con.commit();
        } catch (Exception e) {
