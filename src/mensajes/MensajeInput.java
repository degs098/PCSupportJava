 ...
 * @author samsung
 */
public class MensajeInput extends javax.swing.JDialog {
    ...
    public MensajeInput(java.awt.Frame parent, boolean modal, String mensaje) {
        super(parent, modal);
        ...
        jlmensaje.setBounds(550, 50, 500, 25);
    ...
    /*Este metodo es para ejecutar el consultarUsuario(), ya que si lo llamo directamente en el MouseClicked
     tocaria asignarlo a una variable, y eso no tendria lógica*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajeInput.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MensajeInput dialog = new MensajeInput(new javax.swing.JFrame(), true, "");
