 ...
 * @author samsung
 */
public class ErrorLoginEstado extends javax.swing.JDialog {
    ...
    public ErrorLoginEstado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        jlmensaje = new JLabel("El Usuario se encuentra Inactivo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorLoginEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorLoginEstado dialog = new ErrorLoginEstado(new javax.swing.JFrame(), true);
