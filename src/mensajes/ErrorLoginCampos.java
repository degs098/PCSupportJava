 ...
 * @author samsung
 */
public class ErrorLoginCampos extends javax.swing.JDialog {
    ...
    public ErrorLoginCampos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        jlmensaje = new JLabel("Los campos de Usuario y Clave están vacios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorLoginCampos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorLoginCampos dialog = new ErrorLoginCampos(new javax.swing.JFrame(), true);
